            ...
            <div className="container py-4 py-xl-5">
                <div className="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                    <div className="col" data-aos="fade">
                        <div className="card">
                            <div className="card-body text-center p-4"><img src="/images/services/images.png" width="50" />
                    ...
                    <div className="col" data-aos="fade">
                        <div className="card">
                            <div className="card-body text-center p-4"><img src="/images/services/transparent-web-development-icon-web-design-icon-design-icon-5da1ac0687e196.1781253615708764225566.jpg" width="50" />
                    ...
                    <div className="col">
                        <div className="card">
                            <div className="card-body text-center p-4" data-aos="fade"><img src="/images/services/download.png" width="50" />
